...
export default function MyRequestsModal({ onClose }) {
    ...
    return (
        <div className="modal active">
            <div className="modal-content modal-large">
                ...
                <p style={{ color: 'var(--text-muted)', marginBottom: '16px', fontSize: '13px' }}>Track the status of your submitted shift change requests.</p>
                ...
                <div style={{ maxHeight: '420px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    {loading ? (
                        ...
                        filtered.map(req => {
                            ...
                            return (
                                <div key={req._id} style={{ background: 'var(--bg-elevated)', borderRadius: 'var(--radius-md)', padding: '14px 16px', border: '1px solid var(--border-subtle)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '12px' }}>
